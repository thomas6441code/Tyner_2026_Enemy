...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<'MD'
            Internal REST API for the **Employee Attendance & Permission Management System (EAPMS)**.

            These endpoints form the service-to-service boundary between the `bio-service`
            biometric adapter and the Laravel core. Every request must include a valid
            `X-Internal-Secret` header (see **Security** below) — they are **not** part of the
            public/browser-facing surface, which is served over Inertia, not JSON.
            MD,
    ],

    'ui' => [
        'title' => 'EAPMS Internal API',
    ],
