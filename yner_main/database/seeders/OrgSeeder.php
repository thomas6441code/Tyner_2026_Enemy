...
class OrgSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // A 24-person org spread across the five departments. The first is linked to the
        ...
        //
        // Codes are NOT listed here. They are allocated by EmployeeCodeGenerator like every
        // other employee's, which is the point: seeded data must be reachable by the same path
        // real data takes, or the seeder quietly becomes the one place a hand-typed code is
        // still acceptable. Insertion order is the array order, so this list yields EMP-0001
        // through EMP-0024 — and SeedEmployeeCodesTest pins that, because PermissionSeeder and
        // the location assignment below look employees up by code.
        $sampleEmployees = [
            ['first' => 'Jane', 'last' => 'Mwakasege', 'dept' => 'Finance', 'user' => $employeeUser],
            ['first' => 'John', 'last' => 'Kibwana', 'dept' => 'ICT', 'user' => null],
            ['first' => 'Amina', 'last' => 'Said', 'dept' => 'Human Resources', 'user' => null],
            ['first' => 'Peter', 'last' => 'Mushi', 'dept' => 'Registry', 'user' => null],
            ['first' => 'Grace', 'last' => 'Lyimo', 'dept' => 'Academics', 'user' => null],
            ['first' => 'Hamisi', 'last' => 'Juma', 'dept' => 'Finance', 'user' => null],
            ['first' => 'Neema', 'last' => 'Mollel', 'dept' => 'ICT', 'user' => null],
            ['first' => 'Baraka', 'last' => 'Shirima', 'dept' => 'Human Resources', 'user' => null],
            ['first' => 'Fatuma', 'last' => 'Ally', 'dept' => 'Registry', 'user' => null],
            ['first' => 'Emmanuel', 'last' => 'Massawe', 'dept' => 'Academics', 'user' => null],
            ['first' => 'Rehema', 'last' => 'Kessy', 'dept' => 'Finance', 'user' => null],
            ['first' => 'Daudi', 'last' => 'Nyerere', 'dept' => 'ICT', 'user' => null],
            ['first' => 'Zawadi', 'last' => 'Mahenge', 'dept' => 'Human Resources', 'user' => null],
            ['first' => 'Joseph', 'last' => 'Kimaro', 'dept' => 'Registry', 'user' => null],
            ['first' => 'Halima', 'last' => 'Rashid', 'dept' => 'Academics', 'user' => null],
            ['first' => 'Frank', 'last' => 'Mbwana', 'dept' => 'Finance', 'user' => null],
            ['first' => 'Sophia', 'last' => 'Urassa', 'dept' => 'ICT', 'user' => null],
            ['first' => 'Ibrahim', 'last' => 'Hassan', 'dept' => 'Human Resources', 'user' => null],
            ['first' => 'Mary', 'last' => 'Temba', 'dept' => 'Registry', 'user' => null],
            ['first' => 'Salum', 'last' => 'Omary', 'dept' => 'Academics', 'user' => null],
            ['first' => 'Elizabeth', 'last' => 'Swai', 'dept' => 'Finance', 'user' => null],
            ['first' => 'Michael', 'last' => 'Mwakalinga', 'dept' => 'ICT', 'user' => null],
            ['first' => 'Asha', 'last' => 'Ramadhani', 'dept' => 'Human Resources', 'user' => null],
            ['first' => 'Godfrey', 'last' => 'Mrema', 'dept' => 'Registry', 'user' => null],
        ];
        ...
        // Keyed on name, not code: the code no longer exists until the row does. Names are
        // unique across this fixture set, so re-seeding still matches rather than duplicating.
